"""
train_ls17_v3.py — FaixaBet LS17 (engine moderna)
-------------------------------------------------
Modelo moderno baseado em:
    ...
    - LSTM
    - Dropout
    - Dense binario final (25 unidades)
...
X_PATH = os.path.join(DADOS, "X_ls17.npy")
Y_PATH = os.path.join(DADOS, "y_ls17.npy")

print("[DEBUG] DADOS:", DADOS)
print("[DEBUG] X_ls17 exists?", os.path.exists(X_PATH))
print("[DEBUG] y_ls17 exists?", os.path.exists(Y_PATH))

def main():
    if not os.path.exists(X_PATH) or not os.path.exists(Y_PATH):
        raise FileNotFoundError("X_ls17.npy / y_ls17.npy nao encontrados. Rode build_lf_datasets.py antes.")
    ...
    print("[LOAD] X_ls17:", X.shape)
    print("[LOAD] y_ls17:", y.shape)
    ...
    line = (
        f"{now} | MODEL=LS17_v3 | PATH={out_path} | "
